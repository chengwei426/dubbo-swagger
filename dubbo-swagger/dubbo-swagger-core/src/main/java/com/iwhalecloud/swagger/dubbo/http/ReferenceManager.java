package com.iwhalecloud.swagger.dubbo.http;
...
public class ReferenceManager {
    ...
    public synchronized static ReferenceManager getInstance() {
        ...
        if (!services.isEmpty()) {
			...
			// 获取dubbo的应用名称信息 <dubbo:application name="dubbo-provider" id="dubbo-provider" />
